...
- ✅ **No CONFIG_ Prefix**: Clean output format (`FEATURE=y`, not `CONFIG_FEATURE=y`)
- ✅ **Change Detection**: `oldconfig` detects new/removed options when Kconfig changes
